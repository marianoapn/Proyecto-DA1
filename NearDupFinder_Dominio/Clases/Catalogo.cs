...
public class Catalogo
{
    ...
    public ICollection<Cluster> Clusters => _clusters; 
    ...
    public void EliminarCluster(Cluster c)
    {
        _clusters.Remove(c);
    }
    ...
    {
        return _clusters.FirstOrDefault(c => c.PertenecientesCluster.Contains(item));
    }

    public Cluster? ObtenerClusterPorId(int id)
    {
        return _clusters.FirstOrDefault(c => c.Id == id);
    }
